    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative pt-32 pb-16 px-6 lg:px-8">
        ...
        <div className="relative mx-auto max-w-7xl text-center">
          ...
          <p className="mt-6 mx-auto max-w-2xl text-lg leading-8 text-gray-400 animate-fade-in-up">
        ...
        <div className="mx-auto max-w-3xl px-6 py-24 lg:px-8">
          ...
          <div className="flex flex-col gap-4">
            {[
              ...
              <details key={faq.q} className="group glass rounded-2xl overflow-hidden">
                <summary className="flex cursor-pointer items-center justify-between px-6 py-5 text-sm font-medium text-white transition-colors hover:text-primary list-none [&::-webkit-details-marker]:hidden">
                  <span>{faq.q}</span>
                  <svg className="h-5 w-5 shrink-0 text-muted transition-transform duration-300 group-open:rotate-45" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M12 4.5v15m7.5-7.5h-15" />
                  </svg>
                </summary>
                <div className="px-6 pb-5 text-sm leading-7 text-gray-400">{faq.a}</div>
              </details>
            ))}
          </div>
        </div>
