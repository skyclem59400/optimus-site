    ...
    <>
      ...
      <section className="py-24 sm:py-32 relative">
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <AnimatedSection stagger staggerDelay={0.12} className="grid gap-6 sm:grid-cols-2">
            <AnimatedCard className="glass rounded-2xl p-8 transition-all hover:border-primary/20 hover:shadow-lg hover:shadow-primary/5 group flex flex-col">
              <Link href="/services" className="flex flex-col flex-1">
      ...
      <section className="py-24 sm:py-32 relative">
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <AnimatedSection stagger staggerDelay={0.2} className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
            {[
